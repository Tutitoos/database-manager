...
import { TabLine } from "@/components/ui/tabs";
  ...
  return (
    <>
      ...
      <div className={cn("mt-5 flex h-10 items-end gap-5 border-b", sectionBorder)}>
        <TabLine active={pluginsTab === "instalados"} onClick={() => setPluginsTab("instalados")}>
          <Plug className="h-3.5 w-3.5" />
          Instalados
        </TabLine>
        <TabLine active={pluginsTab === "marketplace"} onClick={() => setPluginsTab("marketplace")}>
